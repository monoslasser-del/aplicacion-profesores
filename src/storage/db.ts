...
export interface Student {
  ...
  curp?: string | null; // Optional field according to NEM standard or similar
  nl?: number;
  group_id?: number | null; // Added group_id from dashboard changes
  hasNfc?: boolean;
  nfc_tag_id?: string;
  isRepetidor?: boolean;
...
class MyAppDatabase extends Dexie {
  ...
  constructor() {
    ...
    this.version(5).stores({
      ...
      activities: '++id, date, sync_status'
    });
  }
}
