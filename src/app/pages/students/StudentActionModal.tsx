            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                <button 
                  onClick={() => {
                    onClose();
                    navigate(`/student/${student.id}/attendance`);
                  }}
                  className="w-full bg-blue-50 flex items-center gap-4 p-4 rounded-2xl active:bg-blue-100 transition-colors"
                >
                  <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center shrink-0">
                ...
                <button 
                  onClick={() => {
                    onClose();
                    navigate(`/student/${student.id}/works`);
                  }}
                  className="w-full bg-purple-50 flex items-center gap-4 p-4 rounded-2xl active:bg-purple-100 transition-colors"
                >
                  <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center shrink-0">
